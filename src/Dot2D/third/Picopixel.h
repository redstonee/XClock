...
#ifndef __PICOPIXEL_H__ 
#define __PICOPIXEL_H__ 
#ifdef __AVR__
 #include <avr/io.h>
...
const unsigned char PicopixelBitmaps[] PROGMEM = {
...
const GFXfont Picopixel PROGMEM = {(unsigned char *)PicopixelBitmaps,
